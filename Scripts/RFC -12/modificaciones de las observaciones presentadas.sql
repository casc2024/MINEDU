...
AS  
 ...
 (SELECT		   
				...
				r.FECHA_FIN,r.FECHA__FIN,r.FechaCeseSancionStr,r.ID_TIPO_SANCION,
...
GO
/****** Object:  StoredProcedure [dbo].[USP_ESCALAFON_ACT_DATOS_SANCION_JUDICIAL_ANULA_IOXML]    Script Date: 27/05/2022 21:48:50 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
'
<root>
  <sancion ID_SANCION_POR_SERVIDOR_PUBLICO="75781" />
  <usuario>
    <row USUARIO="42813053" NOMBRE_USUARIO="CHRISTIAN ABELARDO SCHEREIBER CORNELIO" ID_CENTRO_AMBITO="267" ID_TIPO_CENTRO_AMBITO="2" AMBITO="DRE Lima Metropolitana" CODIGO_ROL="GSD002" ROL="Técnico de escalafón " FECHA_CREACION="27/05/2022 09:51 p. m." ID_USUARIO="80874" />
  </usuario>
</root>
'
*/
...
BEGIN  
	...
	BEGIN TRY
		...
		SELECT	@CODIGO_TIPO_SANCION = TS.CODIGO_TIPO_SANCION,
				@FECHA_INICIO = (CASE ES_DESTITUCION
				WHEN 1 THEN SSP.FECHA_INICIO_INHABILITACION
				WHEN 0 THEN SSP.FECHA_INI_SANCION_SANCION_POR_SERVIDOR_PUBLICO
				END),
				@FECHA_FINAL = (CASE ES_DESTITUCION
				WHEN 1 THEN SSP.FECHA_FIN_INHABILITACION
				WHEN 0 THEN SSP.FECHA_FIN_SANCION_SANCION_POR_SERVIDOR_PUBLICO
				END),
